class Barchart {
    ...
    renderVis() {
      ...
      .join('rect')
        ...
        .attr('y', d => vis.yScale(vis.yValue(d))) // y-position (top of bar)
        .attr('width', vis.xScale.bandwidth()) // bar width
        .attr('height', d => vis.height - vis.yScale(vis.yValue(d))) // bar height
        .attr('fill', d => vis.config.colorScale(vis.colorValue(d))) // fill color by difficulty
